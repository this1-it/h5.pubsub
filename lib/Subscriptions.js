...
Subscriptions.prototype.removeOrQueueRemoval = function(subscription)
{
  ...
  else if (this.subscriptionsPendingRemoval === null)
  {
    this.subscriptionsPendingRemoval = [subscription];
  }
  else
  {
...
Subscriptions.prototype.removePendingSubscriptions = function()
{
  ...
  var subscriptions = this.subscriptions.filter(function(subscription)
  {
    return subscriptionsPendingRemoval.indexOf(subscription) === -1;
  });
